  ...
  class TwitterClient(object): 
    def __init__(self): 
        ...
        try: 
            ...
            auth = OAuthHandler('ukMAzLLUeeALH7O2BynRTNQYl', 'wmz8yZX1sw7J06RRljJwlR0fL32L343Y16Y4p46gXd25vILlBK') 
            # set access token and secret 
            auth.set_access_token('957542425668435968-2r7N47dI0tMc5bU393GNLVetJOFWoRG', 'g0Xscgyd8dx4eBiCugr7ctcQsKEKC4GcH5qPkTnrxz17G') 
